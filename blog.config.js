...
const BLOG = {
  ...
  NOTION_PAGE_ID: '6b354a78615f44fb90fa60f74a979593',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Cuijh', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cuijh.cn', // 网站地址
